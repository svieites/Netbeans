...
<?php
	...
	$sql5 = "SELECT Fecha,ASR,NER,ACD FROM ASR_NER where Pais = 'Grenada' and Fecha between date(date_sub(now(), interval 30 day)) and date(now())";
	$sql6 = "SELECT Fecha,ASR,NER,ACD FROM ASR_NER where Pais = 'Grenada' and Fecha between date(date_sub(now(), interval 45 day)) and date(now())";
	$sql7 = "SELECT Fecha,ASR,NER,ACD FROM ASR_NER where Pais = 'Grenada' and Fecha between date(date_sub(now(), interval 60 day)) and date(now())";
	$sql8 = "SELECT Fecha,ASR,NER,ACD FROM ASR_NER where Pais = 'Grenada' and Fecha between date(date_sub(now(), interval 10 day)) and date(now())";
	$sql9 = "SELECT Fecha,ASR,NER,ACD FROM ASR_NER where Pais = 'Grenada' and Fecha between date(date_sub(now(), interval 20 day)) and date(now())";
  ...
  <link href='stylesheet3.css' rel='stylesheet' type "text/css"/>
    ...
    <script type="text/javascript">
	  ...
	  function init(){
		...
		title: 'ASR - NER - ACD Weekly Comparative Grenada',
