...
<html lang="en">
	<head>
		...
		<body>
			...
			<div class="wrapmanager">
				...
				<ul class="menu">
					...
					<li><a href="#"><img class="icon" src="imagenes/chart.png"> ASR/NER Report</a>
					<ul>
						<li><a href="Barbados_N.php" title=" ASR/NER Barbados Report" target="ventana_iframe"><img class="icon" src="imagenes/barbados.png"> Barbados</a></li>
						<li><a href="Curacao_N.php" title=" ASR/NER Curaco Report" target="ventana_iframe"><img class="icon" src="imagenes/curacao.png"> Curacao</a></li>
						<li><a href="Grenada_N.php" title=" ASR/NER Grenada Report" target="ventana_iframe"><img class="icon" src="imagenes/grenada.png"> Grenada</a></li>
					...
					<li><a href="#"><img class="icon" src="imagenes/data.png"> Maintenance</a>
					<ul>
						<li><a target="ventana_iframe" href="mantenimiento.php"><img class="icon" src="imagenes/maintain.png"> Users Maintenance</a></li>
						<li><a target="ventana_iframe" href="bitacora.php"><img class="icon" src="imagenes/audit.png"> Audit</a></li>
						<li><a target="ventana_iframe" href="kpis_maintenance.html"><img class="icon" src="imagenes/weekly.png"> Weekly Report data</a></li>
					</ul>
					</li>
					<li><a href="#"><img class="icon" src="imagenes/report.png"> VQA Reports</a>
					<ul>
		...
		<div id="footer"><h8>Copyright © Columbus Business Solutions</h8></div></p>
